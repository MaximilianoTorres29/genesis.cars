...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-primary-900/95 backdrop-blur-sm border-b border-primary-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 group">
            <Logo variant="compact" className="text-xl group-hover:opacity-90 transition-opacity" />
          </Link>
